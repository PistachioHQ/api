...
/// SearchTenantsPostRequest : Request body for searching tenants within a project.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct SearchTenantsPostRequest {
    #[serde(rename = "params", skip_serializing_if = "Option::is_none")]
    pub params: Option<Box<models::SearchTenantsPostRequestParams>>,
}

impl SearchTenantsPostRequest {
    /// Request body for searching tenants within a project.
    pub fn new() -> SearchTenantsPostRequest {
        SearchTenantsPostRequest { params: None }
    }
}
